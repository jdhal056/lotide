...
describe("#takeUntil", function() {
  it("returns [1, 2, 5, 7, 2] for ([1, 2, 5, 7, 2, -1, 2, 4, 5], x => x < 0)", function() {
    assert.deepEqual(takeUntil([1, 2, 5, 7, 2, -1, 2, 4, 5], x => x < 0), [1, 2, 5, 7, 2]);
  });

  it("returns [\"I've\", \"been\", \"to\", \"Hollywood\"] for ([\"I've\", \"been\", \"to\", \"Hollywood\", \",\", \"I've\", \"been\", \"to\", \"Redwood\"], x => x === \",\")", function () {
